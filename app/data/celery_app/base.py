...
REDIS_HOST = getenv("LOCAL_REDIS_HOST", None) if ENVIRONMENT == EnvironmentType.DEV else REDIS_HOST = getenv("REDIS_HOST", None)
REDIS_PORT = int(getenv("REDIS_PORT", None))
