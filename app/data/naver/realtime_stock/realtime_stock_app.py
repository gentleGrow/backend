...
async def execute_async_task():
    ...
    world_stock_code_list_chunks = chunked(world_stock_code_list, REALTIME_STOCK_LIST)

    # actor_pool = [
    #     *[KoreaRealtimeStockCollector.remote(stock_code_list_chunk) for stock_code_list_chunk in korea_stock_code_list_chunks],
    #     *[WorldRealtimeStockCollector.remote(stock_code_list_chunk) for stock_code_list_chunk in world_stock_code_list_chunks]
    # ]
    actor_pool = [KoreaRealtimeStockCollector.remote(stock_code_list_chunk) for stock_code_list_chunk in korea_stock_code_list_chunks]
