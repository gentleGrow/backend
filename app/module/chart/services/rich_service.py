...
class RichService:
    ...
    async def get_rich_portfolio_chart_data(self, session: AsyncSession, redis_client:Redis) -> list[PortfolioStockData]:
        result = [] 
        for person_name in RichPeople:
            ...
            asset_percentage = self.asset_service.get_asset_percentages(assets, current_stock_price_map, exchange_rate_map)
