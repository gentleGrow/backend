...
restart-realtime:
	...
	sudo python -m app.data.yahoo.realtime_stock.realtime_stock_app &
	sudo python -m app.data.yahoo.exchange_rate.exchange_rate_app &
	sudo python -m app.data.naver.realtime_index.realtime_index_app &
