...
class TestExchangeRateService:
    ...
    async def test_get_dollar_exchange_rate_for_foreign_asset(
        ...
        # When
        dollar_exchange_rate = exchange_rate_service.get_dollar_exchange_rate(test_asset, exchange_rate_map)
    ...
    async def test_get_won_exchange_rate_for_korean_asset(
        ...
        # When
        won_exchange_rate = exchange_rate_service.get_won_exchange_rate(test_asset, exchange_rate_map)

        # Then
        assert won_exchange_rate == 1.0
